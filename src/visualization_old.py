...
class DataVisualizer:
    ...
    def plot_feature_importance(self, feature_names: List[str], 
        ...
        importance_df = pd.DataFrame({
            ...
            'importance': importance_scores        }).sort_values('importance', ascending=False)
    ...
    def plot_target_distribution(self, target: pd.Series, title: str = "目标变量分布"):
        ...
        # 计算分布
        target_counts = target.value_counts()        target_percentages = target.value_counts(normalize=True) * 100
